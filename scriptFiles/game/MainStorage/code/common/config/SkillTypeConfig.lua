...
白天的阳光产量提升]],
    ...
    ["副-仙人掌"] = SkillType.New({
        ...
        ["升级需求素材"] = {
            ["阳光"] = "180+120,LVL+max(0,LVL-10)*240+max(0,,LVL-15)*180-max(0,,LVL-25)*60-max(0,,LVL-50)*60-max(0,,LVL-70)*60",
            ["金币"] = "10+(20*(LVL-10))",
            ["能量豆"] = "10+(20*(LVL-50))"
        },
        ["主动释放魔法"] = "副_召唤_仙人掌",
    ...
    ["副-地刺"] = SkillType.New({
        ...
        ["升级需求素材"] = {
            ["阳光"] = "0.5(180+120,LVL+max(0,LVL-10)*240+max(0,,LVL-15)*180-max(0,,LVL-25)*60-max(0,,LVL-50)*60-max(0,,LVL-70)*60)"
        },
        ["主动释放魔法"] = "地刺_脉冲",
        ["目标模式"] = "位置",
        ["启用后坐力"] = false,
    ...
    ["副-星星果"] = SkillType.New({
        ...
        ["最大经验"] = "100+LVL*10",
        ["升级需求素材"] = {
            ["阳光"] = "2.2(180+120,LVL+max(0,LVL-10)*240+max(0,,LVL-15)*180-max(0,,LVL-25)*60-max(0,,LVL-50)*60-max(0,,LVL-70)*60)"
        },
        ["主动释放魔法"] = "副_召唤_星星果",
        ["目标模式"] = "位置",
        ["启用后坐力"] = false,
