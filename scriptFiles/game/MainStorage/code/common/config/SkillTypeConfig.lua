...
白天的阳光产量提升 ]],
    ...
    ["向日葵_阳光产量提升"] = SkillType.New({
        ...
        ["一键强化素材"] = {
            ["阳光"] = "3/2((1−min(1,max(0,LVL−4)))*120*1.65^LVL+min(1,max(0,LVL−4))*180*1.6^LVL)"
        },
        ["升级需求素材"] = {
            ["阳光"] = "3/2((1−min(1,max(0,LVL−4)))*120*1.65^LVL+min(1,max(0,LVL−4))*180*1.6^LVL)"
        },
    ...
    ["向日葵_阳光产量提升2"] = SkillType.New({
        ...
        ["一键强化素材"] = {
            ["阳光"] = "6/5((1−min(1,max(0,LVL−4)))*120*1.65^LVL+min(1,max(0,LVL−4))*180*1.6^LVL)"
        },
        ["升级需求素材"] = {
            ["阳光"] = "6/5((1−min(1,max(0,LVL−4)))*120*1.65^LVL+min(1,max(0,LVL−4))*180*1.6^LVL)"
        },
    ...
    ["向日葵_额外掉落阳光"] = SkillType.New({
        ...
        ["一键强化素材"] = {
            ["阳光"] = "((1−min(1,max(0,LVL−4)))*120*1.65^LVL+min(1,max(0,LVL−4))*180*1.6^LVL)"
        },
        ["升级需求素材"] = {
            ["阳光"] = "((1−min(1,max(0,LVL−4)))*120*1.65^LVL+min(1,max(0,LVL−4))*180*1.6^LVL)"
        },
    ...
    ["攻击1_寒冰射手"] = SkillType.New({
        ...
        ["一键强化素材"] = {
            ["阳光"] = "(1−min(1,max(0,x−4)))*120*1.65^x+min(1,max(0,x−4))*180*1.6^x"
        },
        ["升级需求素材"] = {
            ["阳光"] = "(1−min(1,max(0,x−4)))*120*1.65^x+min(1,max(0,x−4))*180*1.6^x"
        },
    ...
    ["寒冰射手"] = SkillType.New({
        ...
        ["显示名"] = "寒冰豌豆",
        ["最大等级"] = 1,
        ["技能描述"] = "发射二枚豌豆，减速并造成[寒冰射手-伤害.属性增伤.1]伤害",
    ...
    ["寒冰加特林"] = SkillType.New({
        ...
        ["显示名"] = "寒冰机枪射手",
        ["最大等级"] = 1,
        ["技能描述"] = "发射2枚豌豆，穿透2个敌人，减速并造成[寒冰射手-伤害.属性增伤.1]伤害。有时还能冰冻敌人。",
    ...
    ["冷冻1_寒冰加特林"] = SkillType.New({
        ...
        ["一键强化素材"] = {
            ["阳光"] = "3/5((1−min(1,max(0,LVL−4)))*9000*1.3^LVL+min(1,max(0,LVL−4))*6000*1.45^LVL)"
        },
        ["升级需求素材"] = {
            ["阳光"] = "3/5((1−min(1,max(0,LVL−4)))*9000*1.3^LVL+min(1,max(0,LVL−4))*6000*1.45^LVL)"
        },
    ...
    ["减速1_寒冰加特林"] = SkillType.New({
        ...
        ["一键强化素材"] = {
            ["阳光"] = "1/2((1−min(1,max(0,LVL−4)))*9000*1.3^LVL+min(1,max(0,LVL−4))*6000*1.45^LVL)"
        },
        ["升级需求素材"] = {
            ["阳光"] = "1/2((1−min(1,max(0,LVL−4)))*9000*1.3^LVL+min(1,max(0,LVL−4))*6000*1.45^LVL)"
        },
    ...
    ["火焰豌豆"] = SkillType.New({
        ["技能名"] = "火焰豌豆",
        ["最大等级"] = 1,
        ["技能描述"] = "连发火焰攻击，造成[火焰豌豆-伤害.属性增伤.1]范围伤害，点燃并造成共[火焰豌豆_dot.属性增伤.1]伤害",
    ...
    ["三头豌豆"] = SkillType.New({
        ...
        ["显示名"] = "三射手",
        ["最大等级"] = 2,
        ["技能描述"] = "发射三枚豌豆，穿透3个敌人，造成[三头豌豆-伤害.属性增伤.1]伤害。且有时能造成双倍伤害",
    ...
    ["高速射手"] = SkillType.New({
        ...
        ["显示名"] = "高速射手",
        ["最大等级"] = 1,
        ["技能描述"] = "发射二枚豌豆，可穿透一名敌人，造成[高速射手-伤害.属性增伤.1]伤害",
    ...
    ["高速加特林"] = SkillType.New({
        ...
        ["显示名"] = "机枪射手",
        ["最大等级"] = 1,
        ["技能描述"] = "发射4发豌豆，可穿透一名敌人，造成[高速加特林-伤害.属性增伤.1]伤害。有时会造成双倍伤害",
    ...
    ["双头豌豆"] = SkillType.New({
        ...
        ["显示名"] = "裂荚射手",
        ["最大等级"] = 1,
        ["技能描述"] = "同时发射二枚豌豆，造成[双头豌豆-伤害.属性增伤.1]伤害。",
    ...
    ["豌豆射手"] = SkillType.New({
        ["技能名"] = "豌豆射手",
        ["最大等级"] = 1,
        ["技能描述"] = "发射豌豆，对僵尸造成[豌豆射手-伤害.属性增伤.1]伤害。",
    ...
    ["副-坚果"] = SkillType.New({
        ...
        ["显示名"] = "坚果",
        ["最大等级"] = 100,
        ["技能描述"] = "召唤出有[副_召唤_坚果.属性增伤.1]的坚果，持续吸引附近僵尸的注意力。持续最多[副_召唤_坚果.持续时间]秒。",
    ...
    ["副-菜问"] = SkillType.New({
        ...
        ["显示名"] = "菜问",
        ["最大等级"] = 100,
        ["技能描述"] = "召唤出有[副_菜问召唤.属性增伤.1]，[副_菜问召唤.属性增伤.1]的菜问近战攻击僵尸。持续最多[副_菜问召唤.持续时间]秒。",
    ...
    ["副-豌豆射手"] = SkillType.New({
        ...
        ["显示名"] = "豌豆射手",
        ["最大等级"] = 100,
        ["技能描述"] = "召唤出豌豆射手持续射击僵尸。持续最多[副_召唤_豌豆射手.持续时间]秒。",
        ["技能图标"] = "sandboxId://textures/plants/Tex_豌豆射手_BaseColor.png",
        ["技能品级"] = "R",
        ["是入口技能"] = true,
        ["技能分类"] = 1,
        ...
        ["最大经验"] = "3*(100*(1+LVL)+max(0,LVL-10)*200+max(0,LVL-25)*300+max(0,LVL-35)*300-max(0,LVL-70)*300)",
        ["升级需求素材"] = {
            ["阳光"] = "44*(180+120*LVL+max(0,LVL-10)*240+max(0,LVL-15)*180-max(0,LVL-25)*60-max(0,LVL-50)*60-max(0,LVL-70)*60)",
            ["金币"] = "2.2*(max(0,LVL-9)*60-max(0,LVL-10)*30+max(0,LVL-15)*90+max(0,LVL-25)*60+max(0,LVL-35)*60+max(0,LVL-50)*60-max(0,LVL-70)*60)"
        },
        ["主动释放魔法"] = "副_召唤_豌豆射手",
        ["目标模式"] = "位置",
        ["启用后坐力"] = true,
    ...
    ["副-仙人掌"] = SkillType.New({
        ...
        ["显示名"] = "仙人掌",
        ["最大等级"] = 100,
        ["技能描述"] = "召唤出有[副-召唤物-仙人掌.属性增伤.1]，[副-召唤物-仙人掌.属性增伤.2]的仙人掌射击僵尸（可穿刺3次）。持续最多[副-召唤物-仙人掌.持续时间]秒。",
    ...
    ["副-椰子炮"] = SkillType.New({
        ...
        ["显示名"] = "椰子炮",
        ["最大等级"] = 100,
        ["技能描述"] = "召唤出有[副_召唤_椰子炮.属性增伤.1]，[副_召唤_椰子炮.属性增伤.2]的椰子炮发射炮弹造成范围伤害。持续最多[副_召唤_椰子炮.持续时间]秒。",
    ...
    ["副-火爆辣椒"] = SkillType.New({
        ...
        ["显示名"] = "火爆辣椒",
        ["最大等级"] = 100,
        ["技能描述"] = "投掷出火爆辣椒，会对命中的敌人造成范围伤害。",
        ["技能详细"] = "投掷出火爆辣椒，大范围爆炸并造成[副-火爆辣椒-飞弹-范围-伤害.属性增伤.1]伤害，并点燃敌人，造成[副-火爆辣椒_持续伤害.属性增伤.1]持续伤害。",
    ...
    ["副-辣椒投手"] = SkillType.New({
        ...
        ["显示名"] = "辣椒投手",
        ["最大等级"] = 1,
        ["技能描述"] = "召唤出有[副_召唤_辣椒投手.属性增伤.1]，[副_召唤_辣椒投手.属性增伤.2]的辣椒投手发射炮燃烧的辣椒造成持续伤害。持续最多[副_召唤_辣椒投手.持续时间]秒。",
    ...
    ["副-钢铁地刺"] = SkillType.New({
        ...
        ["显示名"] = "钢铁地刺",
        ["最大等级"] = 1,
        ["技能描述"] = "召唤出钢铁地刺，使踩过的僵尸受到总计[钢铁地刺_dot.属性增伤.1]伤害。",
    ...
    ["副-星星果"] = SkillType.New({
        ...
        ["显示名"] = "星星果",
        ["最大等级"] = 100,
        ["技能描述"] = "召唤出星星果，星星果每次会发射5颗星弹，对敌人造成大量伤害。",
