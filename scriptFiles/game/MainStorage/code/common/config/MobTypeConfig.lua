...
local function LoadConfig()
    ...
    ["僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["生命"] = "(100^(1+(LVL/20000))+LVL*30)*3/4.5",
            ["攻击"] = "(100^(1+(LVL/20000))+LVL*30)/4.5",
            ["速度"] = "50"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
    ...
    ["寒冰僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["生命"] = "(100^(1+(LVL/20000))+LVL*30)*2",
            ["攻击"] = "(100^(1+(LVL/20000))+LVL*30)/8",
            ["速度"] = "500"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
    ...
    ["摇滚僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["生命"] = "(100^(1+(LVL/20000))+LVL*30)",
            ["攻击"] = "(100^(1+(LVL/20000))+LVL*30)/3",
            ["速度"] = "500"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
    ...
    ["绅士僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["生命"] = "(100^(1+(LVL/20000))+LVL*30)*2.5",
            ["攻击"] = "(100^(1+(LVL/20000))+LVL*30)/5.5",
            ["速度"] = "600"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
