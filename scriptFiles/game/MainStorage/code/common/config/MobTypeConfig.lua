...
local function LoadConfig()
    ...
    ["test"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["攻击"] = "180+120*LVL+max(0,LVL-10)*240+max(0,LVL-15)*80",
    ...
    ["僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["生命"] = "(10+LVL*3)*(3+2*(LVL/60)-0.8*(LVL/60)^2+0.3*(LVL/60)^3)",
            ["攻击"] = "(100+LVL*5)/(20-LVL/50)",
            ["速度"] = "50"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
    ...
    ["士兵僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["攻击"] = "(100+LVL*4)/(5-0.02*LVL+0.00002*LVL^2)",
            ["生命"] = "(100+LVL*5)/(20-LVL/50)",
            ["速度"] = "300"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
    ...
    ["寒冰僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["生命"] = "(10+LVL*6)*(3+2*(LVL/60)-0.8*(LVL/60)^2+0.3*(LVL/60)^3)",
            ["攻击"] = "(100+LVL*5.5)/(20-LVL/50)",
            ["速度"] = "500"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
    ...
    ["摇滚僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["生命"] = "(10+LVL*5)*(3+2*(LVL/60)-0.8*(LVL/60)^2+0.3*(LVL/60)^3)",
            ["攻击"] = "(100+LVL*5)/(20-LVL/50)",
            ["速度"] = "500"
        },
        ["图鉴击杀数"] = 0,
    ...
    ["绅士僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["生命"] = "(10+LVL*7.5)*(3+2*(LVL/60)-0.8*(LVL/60)^2+0.3*(LVL/60)^3)",
            ["攻击"] = "(100+LVL*5.5)/(20-LVL/50)",
            ["速度"] = "600"
        },
        ["图鉴击杀数"] = 0,
