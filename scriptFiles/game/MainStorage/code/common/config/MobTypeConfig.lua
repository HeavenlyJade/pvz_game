...
local function LoadConfig()
    ...
    ["僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["攻击"] = "(10+LVL*3)*(3+2*(LVL/60)-0.8*(LVL/60)^2+0.3*(LVL/60)^3)",
            ["生命"] = "(100+LVL*5)/(5-0.02*LVL+0.00002*LVL^2)",
            ["速度"] = "20"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
    ...
    ["士兵僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["攻击"] = "(10+LVL*4)*(3+2*(LVL/60)-0.8*(LVL/60)^2+0.3*(LVL/60)^3)",
            ["生命"] = "(100+LVL*5.5)/(5-0.02*LVL+0.00002*LVL^2)",
            ["速度"] = "20"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
    ...
    ["寒冰僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["攻击"] = "(10+LVL*6)*(3+2*(LVL/60)-0.8*(LVL/60)^2+0.3*(LVL/60)^3)",
            ["生命"] = "(100+LVL*6)/(5-0.02*LVL+0.00002*LVL^2)",
            ["速度"] = "30"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
    ...
    ["摇滚僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["攻击"] = "(10+LVL*5)*(3+2*(LVL/60)-0.8*(LVL/60)^2+0.3*(LVL/60)^3)",
            ["生命"] = "(100+LVL*5.5)/(5-0.02*LVL+0.00002*LVL^2)",
            ["速度"] = "30"
        },
        ["图鉴击杀数"] = 0,
    ...
    ["绅士僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["攻击"] = "(10+LVL*7.5)*(3+2*(LVL/60)-0.8*(LVL/60)^2+0.3*(LVL/60)^3)",
            ["生命"] = "(100+LVL*6)/(5-0.02*LVL+0.00002*LVL^2)",
            ["速度"] = "35"
        },
        ["图鉴击杀数"] = 0,
