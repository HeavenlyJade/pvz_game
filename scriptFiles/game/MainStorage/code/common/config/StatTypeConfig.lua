...
local function LoadConfig()
    ...
    ["攻击"] = StatType.New({
        ...
        ["优先级"] = 1,
        ["玩家基础值"] = 10,
        ["玩家每级成长"] = "(100+LVL*30+max(0,(LVL-5000)*30)+max(0,(LVL-12000)*60)+max(0,(LVL-16000)*80)+max(0,(LVL-24000)*100)+max(0,(LVL-30000)*100)+max(0,(LVL-35000)*140))/4.5",
        ["图标"] = "fight_active"
    }),
    ["暴伤"] = StatType.New({
        ["属性名"] = "暴伤",
    ...
    ["生命"] = StatType.New({
        ...
        ["优先级"] = 0,
        ["玩家基础值"] = 50,
        ["玩家每级成长"] = "(100+LVL*30+max(0,(LVL-5000)*30)+max(0,(LVL-12000)*60)+max(0,(LVL-16000)*80)+max(0,(LVL-24000)*100)+max(0,(LVL-30000)*100)+max(0,(LVL-35000)*140))",
        ["图标"] = "zijin"
    }),
    ["速度"] = StatType.New({
        ["属性名"] = "速度",
