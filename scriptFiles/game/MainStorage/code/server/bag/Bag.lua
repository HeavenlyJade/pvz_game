...
-- ---@return boolean 是否合成成功
-- function Bag:ComposeItem()
--     -- 检查是否有空位
--     local empty_slot
--     for slot = 0, 9999 do
--         if not self.bag_items[slot] then
--             empty_slot = slot
--             break
--         end
--     end
...
--     local num = 0
--     for slot = 0, 9999 do
--         local tmp_item = self.bag_items[slot]
--         if tmp_item and tmp_item.itype == common_const.ITEM_TYPE.MAT and tmp_item.mat_id == common_const.MAT_ID.FRAGMENT and
--             tmp_item.quality == mat_quality then
--             if tmp_item.num < 800 then
--                 num = tmp_item.num
--                 gg.network_channel:fireClient(self.uin, {
--                     cmd = "cmd_btn_compose_ret",
--                     msg = "no_enough",
...
--                 return false
--             else
--                 tmp_item.num = tmp_item.num - 800
--                 num = tmp_item.num
--                 if tmp_item.num == 0 then
--                     self.bag_items[slot] = nil
--                     local itemType = tmp_item:GetItemType()
--                     if self.bag_index[itemType] then
--                         for i, id in ipairs(self.bag_index[itemType]) do
--                             if id == slot then
--                                 table.remove(self.bag_index[itemType], i)
--                                 break
--                             end
--                         end
--                     end
...
--     newItem:Load(box)
--     self.bag_items[empty_slot] = newItem

--     local newItemType = newItem:GetItemType()
--     if not self.bag_index[newItemType] then
--         self.bag_index[newItemType] = {}
--     end
--     table.insert(self.bag_index[newItemType], empty_slot)
