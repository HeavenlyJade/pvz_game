...
local function LoadConfig()
    ...
    ["僵尸"] = MobType.New({
        ...
        ["基础等级"] = 26,
        ["属性公式"] = {
            ["生命"] = "(100+LVL*30+max(0,(LVL-5000)*30)+max(0,(LVL-12000)*60)+max(0,(LVL-16000)*80)+max(0,(LVL-24000)*100)+max(0,(LVL-30000)*250)+max(0,(LVL-35000)*500))*3/5",
            ["攻击"] = "(100+LVL*30+max(0,(LVL-5000)*30)+max(0,(LVL-12000)*60)+max(0,(LVL-16000)*80)+max(0,(LVL-24000)*150)+max(0,(LVL-30000)*250)+max(0,(LVL-35000)*400))/5",
            ["速度"] = "50"
        },
        ["图鉴击杀数"] = 0,
        ["图鉴完成奖励"] = nil,
