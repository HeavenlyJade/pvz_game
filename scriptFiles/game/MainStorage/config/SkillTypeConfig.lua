...
local function LoadConfig()
    ...
    ["向日葵1-1阳光产量提升"] = SkillType.New({
        ["技能名"] = "向日葵1-1阳光产量提升",
        ["显示名"] = "阳光产量提升",
        ["最大等级"] = 10,
        ["最大阶级"] = 0,
        ["技能详细"] = "挂机获得阳光+{100*[1.威力增加]}%",
        ["技能图标"] = "sandboxId://textures/ui/主界面UI/主副卡界面/主卡界面/阳光提升.png",
        ["技能品级"] = "UR",
        ["是入口技能"] = false,
        ["技能分类"] = 0,
        ["提升玩家等级"] = "min(2,max(1,LVL-3))",
        ["下一技能"] = {
            "向日葵2-1挂机获得硬币"
        },
        ["无需装备也可生效"] = true,
    ...
    ["向日葵1-2植物伤害增加"] = SkillType.New({
        ["技能名"] = "向日葵1-2植物伤害增加",
        ["显示名"] = "植物伤害增加",
        ["最大等级"] = 10,
        ["最大阶级"] = 0,
        ["技能详细"] = "所有植物伤害+{[1.增伤]}%",
        ["技能图标"] = "sandboxId://textures/ui/主界面UI/主副卡界面/主卡界面/攻击提升.png",
        ["技能品级"] = "UR",
        ["是入口技能"] = false,
        ["技能分类"] = 0,
        ["下一技能"] = {
    ...
    ["向日葵2-1挂机获得硬币"] = SkillType.New({
        ["技能名"] = "向日葵2-1挂机获得硬币",
        ["显示名"] = "挂机获得硬币",
        ["最大等级"] = 10,
        ["最大阶级"] = 0,
        ["技能详细"] = "挂机[1.几率]%概率获得5金币",
        ["技能图标"] = "sandboxId://textures/ui/主界面UI/货币单图/金币.png",
        ["技能品级"] = "UR",
        ["是入口技能"] = false,
        ["技能分类"] = 0,
        ["下一技能"] = {
    ...
    ["孪生葵"] = SkillType.New({
        ...
        ["最大等级"] = 1,
        ["最大阶级"] = 0,
        ["实际描述"] = "嘿！现在你可以获得跟多的阳光了！",
        ["技能图标"] = "sandboxId://textures/plants/孪生葵.png",
        ["技能小角标"] = "sandboxId://textures/ui/主界面UI/主副卡界面/主卡界面/阳光提升.png",
        ["技能品级"] = "UR",
        ["是入口技能"] = false,
        ["技能分类"] = 0,
    ...
    ["三头豌豆"] = SkillType.New({
        ...
        ["最大等级"] = 2,
        ["最大阶级"] = 0,
        ["实际描述"] = "发射三枚豌豆，穿透3个敌人，造成70%攻击伤害。且有时能造成双倍伤害",
    ...
    ["机枪射手"] = SkillType.New({
        ...
        ["最大等级"] = 1,
        ["最大阶级"] = 0,
        ["实际描述"] = "发射4发豌豆，可穿透一名敌人，造成DamageAmplifier伤害。有时会造成双倍伤害",
    ...
    ["双头豌豆"] = SkillType.New({
        ...
        ["最大等级"] = 1,
        ["最大阶级"] = 0,
        ["实际描述"] = "同时发射二枚豌豆，造成DamageAmplifier伤害。",
    ...
    ["副-仙人掌"] = SkillType.New({
        ...
        ["最大等级"] = 100,
        ["最大阶级"] = 0,
        ["实际描述"] = "召唤出仙人掌射击僵尸（可穿刺3次）。持续最多30秒。冷却40秒。",
