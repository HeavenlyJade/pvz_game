...
local function LoadConfig()
    ...
    ["产量增加_额外概率提升"] = SkillType.New({
        ...
        ["一键强化素材"] = {
            ["阳光"] = "15*(1-min(1,max(0,LVL-4)))*9000*1.3^LVL+min(1,max(0,LVL-4))*6000*1.45^LVL"
        },
        ["升级需求素材"] = {
            ["阳光"] = "15*(1-min(1,max(0,LVL-4)))*9000*1.3^LVL+min(1,max(0,LVL-4))*6000*1.45^LVL"
        },
...
白天的阳光产量提升 ]],
    ...
    ["向日葵_阳光产量提升"] = SkillType.New({
        ...
        ["一键强化素材"] = {
            ["阳光"] = "15*((1-min(1,max(0,LVL-4)))*120*1.65^LVL+min(1,max(0,LVL-4))*180*1.6^LVL)"
        },
        ["升级需求素材"] = {
            ["阳光"] = "15*((1-min(1,max(0,LVL-4)))*120*1.65^LVL+min(1,max(0,LVL-4))*180*1.6^LVL)"
        },
    ...
    ["向日葵_阳光产量提升2"] = SkillType.New({
        ...
        ["一键强化素材"] = {
            ["阳光"] = "10*((1-min(1,max(0,LVL-4)))*120*1.65^LVL+min(1,max(0,LVL-4))*180*1.6^LVL)"
        },
        ["升级需求素材"] = {
            ["阳光"] = "10*((1-min(1,max(0,LVL-4)))*120*1.65^LVL+min(1,max(0,LVL-4))*180*1.6^LVL)"
        },
    ...
    ["持续伤害_胆小菇"] = SkillType.New({
        ...
        ["升级需求素材"] = {
            ["阳光"] = "20*(1−min(1,max(0,LVL−4)))*9000*1.3^LVL+min(1,max(0,LVL−4))*6000*1.45^LVL"
        },
        ["主动释放魔法"] = nil,
        ["目标模式"] = "敌人",
        ["启用后坐力"] = false,
    ...
    ["攻击1_寒冰射手"] = SkillType.New({
        ...
        ["一键强化素材"] = {
            ["阳光"] = "10*(1−min(1,max(0,x−4)))*120*1.65^x+min(1,max(0,x−4))*180*1.6^x"
        },
        ["升级需求素材"] = {
            ["阳光"] = "10*(1−min(1,max(0,x−4)))*120*1.65^x+min(1,max(0,x−4))*180*1.6^x"
        },
    ...
    ["生命1_豌豆"] = SkillType.New({
        ...
        ["升级需求素材"] = {
            ["阳光"] = "0*(1-min(1,max(0,LVL-4)))*120*1.65^LVL+min(1,max(0,LVL-4))*180*1.6^LVL"
        },
        ["主动释放魔法"] = nil,
        ["目标模式"] = "敌人",
        ["启用后坐力"] = false,
    ...
    ["豌豆射手"] = SkillType.New({
        ...
        ["显示名"] = "豌豆射手",
        ["最大等级"] = 1,
        ["实际描述"] = "发射豌豆，对僵尸造成DamageAmplifier伤害。",
